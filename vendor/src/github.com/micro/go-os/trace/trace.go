...
func ClientWrapper(t Trace, s *registry.Service, cfg config.Config, isRoot bool) client.Wrapper {
	return func(c client.Client) client.Client {
		return &clientWrapper{c, t, s, cfg, isRoot}
	}
}

func HandlerWrapper(t Trace, s *registry.Service, cfg config.Config) server.HandlerWrapper {
	return func(h server.HandlerFunc) server.HandlerFunc {
		return handlerWrapper(h, t, s, cfg)
	}
}
